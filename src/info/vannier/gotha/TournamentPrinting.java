...
//        try {
//            imgW = ImageIO.read(new File("whitestone.png"));
//            imgB = ImageIO.read(new File("blackstone.png"));
//        } catch (IOException e) {
//        }
//        
//        g.drawImage(imgW, 100, 800, null);
//        g.drawImage(imgB, 150, 800, null);
